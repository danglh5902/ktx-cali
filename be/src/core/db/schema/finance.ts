...
export const billingPeriods = pgTable("billing_periods", {
  ...
  totalAmount: money("total_amount").notNull().default(sql`0`),
...
export const invoices = pgTable("invoices", {
  ...
  issueDate: date("issue_date"),
  dueDate: date("due_date"),
  subtotal: money("subtotal").notNull().default(sql`0`),
  discountTotal: money("discount_total").notNull().default(sql`0`),
  penaltyTotal: money("penalty_total").notNull().default(sql`0`),
  adjustmentTotal: money("adjustment_total").notNull().default(sql`0`),
  grandTotal: money("grand_total").notNull().default(sql`0`),
  paidAmount: money("paid_amount").notNull().default(sql`0`),
...
export const payments = pgTable("payments", {
  ...
  allocatedAmount: money("allocated_amount").notNull().default(sql`0`),
  unallocatedAmount: money("unallocated_amount").notNull().default(sql`0`),
